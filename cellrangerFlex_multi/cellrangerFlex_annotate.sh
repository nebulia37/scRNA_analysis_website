...
$workdir/script/cellranger_annotate.sh $workdir/toDeliver/cellrangerResult/${poolID}/outs/per_sample_outs $cellranger
if [ -d $workdir/toDeliver/cellrangerResult/${poolID}/outs ];then
    mkdir -p $workdir/toDeliver/cellrangerResult/${poolID}_tmp
    mv $workdir/toDeliver/cellrangerResult/${poolID}/outs/* $workdir/toDeliver/cellrangerResult/${poolID}_tmp/
    rm -r $workdir/toDeliver/cellrangerResult/${poolID}
    mv $workdir/toDeliver/cellrangerResult/${poolID}_tmp $workdir/toDeliver/cellrangerResult/${poolID}
fi
